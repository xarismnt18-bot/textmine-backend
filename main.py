...
def extract_text(file: UploadFile) -> str:
    """Extract raw text from TXT, PDF, or XLSX file."""
...
def clean_tokens(text: str, remove_stopwords: bool = True, lemmatize: bool = False) -> list[str]:
...
async def analyze_bertopic(
    ...
    # Split into sentences / paragraphs as docs
...
async def analyze_sentiment(
    ...
    return {
        "method": "sentiment",
        "summary": summary,
        "sentences": results[:100],  # cap at 100 for response size
    }
